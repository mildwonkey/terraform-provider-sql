...
type GRPCProviderFunc6 func() tfprotov6.ProviderServer
...
type ServeOpts struct {
	...
	// protov6 provider fun
	GRPCProviderFunc6 GRPCProviderFunc6
...
func Serve(opts *ServeOpts) {
	...
	if opts.GRPCProviderFunc6 == nil && opts.ProviderFunc != nil {
		opts.GRPCProviderFunc6 = func() tfprotov6.ProviderServer {
			return schema.NewGRPCProviderServer6(opts.ProviderFunc())
		}
	}
